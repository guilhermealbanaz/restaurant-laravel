...
<div class="container mx-auto px-4 py-6">
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-3xl font-bold text-gray-800">Editar Prato</h1>
            <p class="text-gray-600 mt-1">Atualize as informações do prato</p>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="price" id="price" value="{{ old('price', $dish->price) }}" step="0.01" min="0" required 
                               class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>

                    <div>
                        <label for="preparation_time" class="block text-sm font-medium text-gray-700 mb-1">Tempo de preparo (minutos)</label>
                        <input type="number" name="preparation_time" id="preparation_time" value="{{ old('preparation_time', $dish->preparation_time) }}" min="1" 
                               class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    ...
                    <div class="space-y-3 pt-3 border-t border-gray-200">
                        <div class="flex items-center">
                            ...
                            <input type="checkbox" name="available" id="available" value="1" {{ old('available', $dish->available) ? 'checked' : '' }}
                        ...
                        <div class="flex items-center">
                            ...
                            <input type="checkbox" name="featured" id="featured" value="1" {{ old('featured', $dish->featured) ? 'checked' : '' }}
                                   class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                    ...
                    <div class="space-y-3 pt-3 border-t border-gray-200">
                        ...
                        <div class="flex items-center">
                            ...
                            <input type="checkbox" name="is_vegetarian" id="is_vegetarian" value="1" {{ old('is_vegetarian', $dish->is_vegetarian) ? 'checked' : '' }}
                        ...
                        <div class="flex items-center">
                            ...
                            <input type="checkbox" name="is_vegan" id="is_vegan" value="1" {{ old('is_vegan', $dish->is_vegan) ? 'checked' : '' }}
                                   class="h-4 w-4 text-green-600 border-gray-300 rounded focus:ring-green-500">
                        ...
                        <div class="flex items-center">
                            ...
                            <input type="checkbox" name="is_gluten_free" id="is_gluten_free" value="1" {{ old('is_gluten_free', $dish->is_gluten_free) ? 'checked' : '' }}
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        @if($dish->image)
                            <div class="mb-2">
                                <img src="{{ asset('storage/' . $dish->image) }}" alt="{{ $dish->name }}" class="h-48 w-auto object-cover rounded">
                                <p class="text-xs text-gray-500 mt-1">Imagem atual. Envie uma nova para substituí-la.</p>
                            </div>
                        @endif
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="3" 
                                  class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">{{ old('description', $dish->description) }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="ingredients" id="ingredients" rows="3" 
                                  class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">{{ old('ingredients', $dish->ingredients) }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea name="allergens" id="allergens" rows="2" 
                                  class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">{{ old('allergens', $dish->allergens) }}</textarea>
